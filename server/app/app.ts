import { BoardGameController } from '@app/controllers/board-game/board-game.controller';
...
export class Application {
    ...
    private config(): void {
        ...
        this.app.use(
            express.json({
                limit: '50mb', // ⬅️ bump this to what you *actually* need
            }),
        );
        ...
        this.app.use(
            express.urlencoded({
                extended: true,
                limit: '50mb', // ⬅️ same here for form-encoded
            }),
        );
